    ...
    def read_from_path(self, path: Path):
        with open(path, "rb") as aseprite_file:
            try:
                ...
                flags = struct.unpack("<i", file_header[10:14])[0]
                ...
                self.frame_speed = struct.unpack(
                    "<i", file_header[18:20] + b"\x00\x00"
                )[0]
                ...
                self.grid_width = struct.unpack("<i", file_header[36:38] + b"\x00\x00")[
                    0
                ]
                self.grid_height = struct.unpack(
                    "<i", file_header[38:40] + b"\x00\x00"
                )[0]
                ...
                number_of_frames = struct.unpack("<i", file_header[6:8] + b"\x00\x00")[
                    0
                ]
